    ...
    <div>
      <Box display="flex" flexWrap="wrap">
        ...
        <StyledPaper>
          <h3>Defense</h3>
          <h4>Health</h4>
          <p>Max: {characterData.defense.health.max}</p>
          <h4>Armor Class</h4>
          <TableContainer>
            <Table>
              <TableHead>
          ...
          <TableContainer>
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <StyledTableCell>
                    {characterData.gear.money.pp}
                  </StyledTableCell>
                  <StyledTableCell>
                    {characterData.gear.money.gp}
                  </StyledTableCell>
                  <StyledTableCell>
                    {characterData.gear.money.sp}
                  </StyledTableCell>
                  <StyledTableCell>
                    {characterData.gear.money.cp}
                  </StyledTableCell>
                </TableRow>
              </TableBody>
            </Table>
